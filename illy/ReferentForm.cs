...
namespace illy
{
    public partial class ReferentForm: Form
    {
        ...
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            try
            {
                // Adresa e email-it të referentit
                string emailAddress = "rrita.basha@universitetiaab.com";

                // Subjekti i email-it
                string subject = "Përshëndetje";

                // Përmbajtja (body) e email-it
                string body = "Përshëndetje Rrita,\n\nKam një pyetje në lidhje me orarin e provimeve.\nFaleminderit!";
                ...
                // Hap Gmail në shfletues me email-in e ri
